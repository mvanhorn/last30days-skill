...
| **Taxminator** | ウズベキスタンの予測市場。中央アジアのサッカー、チェス、eスポーツ、経済についての集合予測。3言語対応（uz/ru/en）。お金ではなくポイント制で、賭け金ではなく予測者の割合です。 |
...
| 情報源 | 必要なもの | 費用 |
|---------|---------------|------|
| Reddit(コメント込み)+ HN + Polymarket + Taxminator + GitHub + StockTwits | 不要 | 無料 |
