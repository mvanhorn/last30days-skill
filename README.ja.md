...
| **V2EX** | 中国の技術コミュニティのシグナル。V2EX の公開 API から人気トピックとノード一覧を取得し、関連性でフィルタリングします。無料、API キー不要。 |
| **Xueqiu（雪球）** | 中国の投資家センチメント。公開タイムラインのステータスを関連性でフィルタリング。`XUEQIU_COOKIE` 設定時、ティッカー/暗号資産トピックで自動有効化。 |
