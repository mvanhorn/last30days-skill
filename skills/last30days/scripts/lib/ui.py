...
PROMO_SINGLE_KEY = {
    ...
    "x": "\n💡 Unlock X: log into x.com in Firefox or Safari, then re-run (for Chrome, Brave, Edge, Arc, Vivaldi or Opera, set FROM_BROWSER=auto). Or add AUTH_TOKEN/CT0 or XAI_API_KEY.\n",
