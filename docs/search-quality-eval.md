...
- It passes `XAI_API_KEY`, Codex/OpenAI auth fields, and `SCRAPECREATORS_API_KEY`, but intentionally does not pass browser-cookie X auth. That keeps evaluation runs on the popup-free path.
