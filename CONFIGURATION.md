...
| Taxminator | none | always on. Uzbek prediction market — crowd forecasts on Central Asian football, CIS chess, esports, the Uzbek economy and entertainment, matched against uz/ru/en titles. Points-based, not money: the published split is the share of predictors, and below the reveal floor no split is published at all. | yes (public read API, no auth) |
