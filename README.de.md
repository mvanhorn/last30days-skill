...
| **Diffbot** | Der Nachrichten- und Artikelindex. Datumsbegrenzte Artikel aus dem Diffbot Knowledge Graph, nach Relevanz und Frische sortiert. Automatisch aktiv, wenn `DIFFBOT_API_KEY` gesetzt ist. |
...
| Diffbot (Nachrichten/Artikel) | Diffbot-API-Token (`DIFFBOT_API_KEY`) | Kostenlose Stufe, danach nutzungsabhängig |
